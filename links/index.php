...
<html lang = "en">
  ...
  <body>
        <div class = "container">
          <header class="header">
            <div>
              <a href = "https://www.singhpalwinder.com"><img src = "pfp.png" alt = "Profile picture"></a>
            </div>
            <div>
              <a href="https://www.singhpalwinder.com/links">@_singhpalwinder<span class="material-symbols-outlined">&#xef76;</span></a>
            </div>
          </header>
             <div class = "links">
                <div>
                ...
                <div>
                  <a class = "button" href = "20wk_powerbuilding.numbers">
                    <div class="button-image">
                      <img src="images/free_workout_plan.png" alt="free workout plan">
                    </div> 
                    <span class="button-text">Free Workout Plan</span>
                  </a>
                </div>
                <div>
