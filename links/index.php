  ...
  <body>
    ...
    <div class="content"> <!-- Content layer -->
      <header>
        ...
        <div>
          <a href="https://www.singhpalwinder.com/links">@_singhpalwinder</a>
        </div>
      </header>
      ...
      <div class="links">
        ...
        <div>
          <a class="button" href="https://music.apple.com/us/playlist/multi-cultural-gym-hype/pl.u-yZyVJVxFqBY37a">
            <div class="button-image">
              <img src="images/playlist_logo.png" alt="Gym Playlist">
            </div>
      ...
      <footer>
        ...
        <div><h3>Self hosted by Palwinder Singh</h3></div>
      </footer>
    </div>
  </body>
</html>